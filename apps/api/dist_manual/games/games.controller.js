...
import { Controller, Post, Get, UseGuards, Put } from '@nestjs/common';
import { AuthGuard } from '@nestjs/passport';
let GamesController = (() => {
    let _classDecorators = [Controller('games'), UseGuards(AuthGuard('jwt'))];
    ...
    var GamesController = class {
        ...
        gamesService = __runInitializers(this, _instanceExtraInitializers);
